...
class _CityBusGroupedViewState extends State<CityBusGroupedView> {
  ...
  String _getBusLocationStatus(String routeKey) {
    // ViewModel에 수집된 해당 노선 실시간 데이터 확인
